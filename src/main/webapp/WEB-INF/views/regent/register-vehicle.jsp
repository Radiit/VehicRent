                    ...
                    <div class="form-left">
                        <div class="form-left-inner">
                            <div>
                                ...
                                <select class="form-select" aria-label="Default select example" style="width: 300px; height: 35px; border-radius: 10px;">
                                    <option selected>Pilih jenis kendaraan</option>
                                    <option value="1">Mobil Keluarga</option>
                                    <option value="2">Mobil Travel</option>
                                    <option value="3">Mobil Angkut</option>
                                    <option value="4">Mobil Mewah</option>
                                    <option value="5">Sepeda Motor</option>
                                    <option value="6">Motor Mewah</option>
                                </select>
                                <div class="form-input">
                                    <label for="Merk">Merk</label>
                                    <input type="text" placeholder="Masukkan Merk Kendaraan Anda">
                                </div>
                                <div class="form-input">
                                    <label for="Model">Model</label>
                                    <input type="text" placeholder="Masukkan Model Kendaraan Anda">
                                </div>
                                <div class="form-input">
                                ...
                                <div class="form-input">
                                    ...
                                    <input type="text" placeholder="Masukkan Warna Kendaraan Anda">
                                </div>
                                <div class="form-input">
                            ...
                            <div>
                                ...
                                <div class="form-input">
                                    ...
                                    <input type="file" id="stnkInput" accept="image/*" onchange="handleImageUpload()">
                                    <img id="stnkPreview" src="#" alt="STNK Preview" style="display:none; max-width: 100%; max-height: 200px; margin-top: 10px;">
                                </div>                                
                                <div class="form-input">
                                    <label for="transmisi">Transmisi</label>
                                    <input type="text" placeholder="Masukan Transmisi Kendaraan Anda">
                                </div>
                            </div>
                        </div>
